...
<head>
    <meta charset="utf-8">
    <title>CineGlobo | Listagem Cinemas</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-secondary navbar-dark sticky-top py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link active dropdown-toggle" data-bs-toggle="dropdown">Cinemas</a>
                    <div class="dropdown-menu m-0">
                    <?php if (isset($_SESSION['username'])) : ?>    
    ...
    <!-- Page Header Start -->
    <div class="container-fluid page-header-cinemas py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white text-uppercase mb-3 animated slideInDown">Cinemas</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center text-uppercase mb-0">
                    <li class="breadcrumb-item"><a class="text-white" href="index.html">Home</a></li>
                    <li class="breadcrumb-item"><a class="text-white" href="#">Cinemas</a></li>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <p class="d-inline-block bg-secondary text-primary py-1 px-4">Listagem de Cinemas</p>
                <h1 class="text-uppercase">Conheça os nossos estabelecimentos</h1>
            </div>
            <table class="table table-striped" id="tabelaCinemas">
                <thead>
                    <tr>
                        <th scope="col">ID</th>
    ...
    <div class="modal fade" id="modalCinema" tabindex="-1" aria-labelledby="modalCinemaLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content" style="background-color: #191C24;">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="modalCinemaLabel">Edição de Cinema</h1>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="container">
                        <div class="card" style="border: black;">
                            <h5 class="card-header" style="background-color: #191C24;">Edite aqui as informações do Cinema</h5>
                            <div class="card-body" style="background-color: #1f2127;">
                                <form class="row g-3">
                                    <div class="col-8">
                                        <label for="nomeCinemaEdit" class="form-label">Nome</label>
                                        <input type="text" class="form-control bg-dark text-white" id="nomeCinemaEdit">
                                    </div>
                                    <div class="col-4">
                                        <label for="telefoneCinemaEdit" class="form-label">Telefone</label>
                                        <input type="tel" class="form-control bg-dark text-white" id="telefoneCinemaEdit">
                                    </div>
                                    <div class="col-6">
                                        <label for="selectLocalCinemaEdit" class="form-label">Localidade</label>
                                        <select class="form-select bg-dark text-white" id="selectLocalCinemaEdit">
        
                                        </select>
                                    </div>
                                    <div class="col-6">
                                        <label for="emailCinemaEdit" class="form-label">Email</label>
                                        <input type="email" class="form-control bg-dark text-white" id="emailCinemaEdit">
                                    </div>
                                </form>
                            </div>
                        </div>
