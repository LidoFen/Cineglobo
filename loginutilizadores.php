    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <p class="d-inline-block bg-secondary text-primary py-1 px-4">Login Utilizadores</p>
                <h1 class="text-uppercase">Efetue aqui o seu login</h1>
            </div>
                        ...
                        <div class="card-body">
                            <form class="row g-3">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control bg-dark text-white" id="usernameLogin">
                                </div>
                                <div class="col-12">
                                    <label for="password" class="form-label">Password</label>
                                    <input type="password" class="form-control bg-dark text-white" id="passwordLogin">
                                </div>
                                <div class="col-12 text-center"> <!-- Center the button -->
                                    <button type="button" class="m-3 btn btn-primary" onclick="login()">Login</button>
                                </div>
                            </form>
                        </div>
                    </div>
