...
<head>
    <meta charset="utf-8">
    <title>CineGlobo | Registo Filmes</title>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <p class="d-inline-block bg-secondary text-primary py-1 px-4">Registo de Filmes</p>
                <h1 class="text-uppercase">Efetue aqui o registo de Filmes</h1>
            </div>
                        ...
                        <div class="card-body">
                            <form class="row g-3">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control bg-dark text-white" id="nomeFilme">
                                </div>
                                <div class="col-12">
                                    <label for="descricaoFilme" class="form-label">Descrição</label>
                                    <textarea class="form-control bg-dark text-white" placeholder="" id="descricaoFilme" style="height: 100px"></textarea>
                                </div>
                                <div class="col-6">
                                    <label for="selectTipoFilme" class="form-label">Tipo</label>
                                    <select class="form-select bg-dark text-white" id="selectTipoFilme"></select>
                                </div>
                                <div class="col-6">
                                    <label for="cartazFilme" class="form-label">Cartaz</label>
                                    <input type="file" class="form-control bg-dark text-white" id="cartazFilme">
                                </div>
                                <div class="mt-3 d-flex justify-content-center">
                                    <img id="cartazPreview" src="#" alt="Preview" class="img-thumbnail" style="max-width: 100%; max-height: 300px; display: none;">
                                </div>
                                <div class="col-12 text-center">
                                    <button type="button" class="m-3 btn btn-primary" onclick="registaFilme()">Registar</button>
                                </div>
                            </form>
                        </div>
                    </div>
