...
<head>
    <meta charset="utf-8">
    <title>CineGlobo | Registo Cinemas</title>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <p class="d-inline-block bg-secondary text-primary py-1 px-4">Registo de Cinemas</p>
                <h1 class="text-uppercase">Efetue aqui o registo de Cinemas</h1>
            </div>
                        ...
                        <div class="card-body">
                            <form class="row g-3">
                                <div class="col-8">
                                    ...
                                    <input type="text" class="form-control bg-dark text-white" id="nomeCinema">
                                </div>
                                <div class="col-4">
                                    <label for="telefoneCinema" class="form-label">Telefone</label>
                                    <input type="tel" class="form-control bg-dark text-white" id="telefoneCinema">
                                </div>
                                <div class="col-6">
                                    <label for="selectLocalCinema" class="form-label">Localidade</label>
                                    <select class="form-select bg-dark text-white" id="selectLocalCinema">
    
                                    </select>
                                </div>
                                <div class="col-6">
                                    <label for="emailCinema" class="form-label">Email</label>
                                    <input type="email" class="form-control bg-dark text-white" id="emailCinema">
                                </div>
                                <div class="col-12 text-center"> <!-- Center the button -->
                                    <button type="button" class="m-3 btn btn-primary" onclick="registaCinema()">Registar</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <span>Rua de Cima, nº1, Évoa</span>
                    </div>
                    <div class="d-flex align-items-center mb-2">
                        <div class="btn-square bg-dark flex-shrink-0 me-3">
